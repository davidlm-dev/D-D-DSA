public class Warrior extends Character {
    public Warrior(String name, int strength, int intelligence, int wisdom, int dexterity, int constitution, int charisma, String alignment) {
        super(name, strength, intelligence, wisdom, dexterity, constitution, charisma, alignment);
    }

    @Override
    public void displayInfo() {
        System.out.println("Guerrero: " + name);
