public class Halfling extends Character{
    public Halfling(String name, int strength, int intelligence, int wisdom, int dexterity, int constitution, int charisma, String alignment) {
        super(name, strength, intelligence, wisdom, dexterity, constitution, charisma, alignment);
    }

    @Override
    public void displayInfo() {
        System.out.println("Mediano: " + name);
